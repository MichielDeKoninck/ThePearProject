...
%     x3 = coordinatesMatrix(3,2); y3 = coordinatesMatrix(3,3);
    ...
    k_e1_1 = ((sigma_r*dphi1_dr*dphi1_dr)+(sigma_z*dphi1_dz*dphi1_dz))*fixed_sum;
    k_e2_2 = ((sigma_r*dphi2_dr*dphi2_dr)+(sigma_z*dphi2_dz*dphi2_dz))*fixed_sum;
    k_e3_3 = ((sigma_r*dphi3_dr*dphi3_dr)+(sigma_z*dphi3_dz*dphi3_dz))*fixed_sum;

    k_e1_2 = ((sigma_r*dphi1_dr*dphi2_dr)+(sigma_z*dphi1_dz*dphi2_dz))*fixed_sum;
    k_e1_3 = ((sigma_r*dphi1_dr*dphi3_dr)+(sigma_z*dphi1_dz*dphi3_dz))*fixed_sum;
    k_e2_3 = ((sigma_r*dphi2_dr*dphi3_dr)+(sigma_z*dphi2_dz*dphi3_dz))*fixed_sum;
